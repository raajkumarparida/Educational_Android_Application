...
public class ChemistryLectureFragment extends Fragment {
    ...
    public ChemistryLectureFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_chemistry_lecture, container, false);
