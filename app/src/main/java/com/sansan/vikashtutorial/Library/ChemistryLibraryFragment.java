...
public class ChemistryLibraryFragment extends Fragment {
    ...
    public ChemistryLibraryFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_chemistry_library, container, false);
