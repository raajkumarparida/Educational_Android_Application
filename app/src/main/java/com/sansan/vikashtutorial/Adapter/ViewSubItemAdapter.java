...
public class ViewSubItemAdapter extends RecyclerView.Adapter<ViewSubItemAdapter.SubItemViewHolder> {
    ...
    public ViewSubItemAdapter(Context context, List<HomePdfSubItem> subItemList) {
    ...
    public SubItemViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_view_sub_item, viewGroup, false);
