...
public class OurResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_our_result);
    ...
    private void fetchSemesters() {
        progressDialog.show();
        firestore.collection("OurResult")
                .get()
                .addOnCompleteListener(task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        for (QueryDocumentSnapshot document : task.getResult()) {
                            String semesterName = document.getString("selectYear");
                            String examImg = document.getString("img");
                            List<Map<String, String>> subjects = (List<Map<String, String>>) document.get("result");
                            ...
                            if (subjects != null) {
                                for (Map<String, String> subject : subjects) {
                                    subjectNames.add(subject.get("year"));
