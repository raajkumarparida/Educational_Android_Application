...
public class MockAdapter extends RecyclerView.Adapter<MockAdapter.MyViewHolder> {
    private Context context;
    private List<MockItem> mockItemList;
    private ProgressDialog progressDialog;

    public MockAdapter(Context context, List<MockItem> mockItemList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.layout_mock_item, parent, false);
